...
namespace DATOS.UTIL
{
    public class AccesoDatos : IDisposable
    {
        ...
        private InfoStoredProcedure _StoreProcedure;
        /// <summary>
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public InfoStoredProcedure StoreProcedure
        {
            get
            {
        ...
        /// </param>
        /// <remarks></remarks>
        public AccesoDatos(bool conTransaccion)
        {
            try
            {
                //Construye la cadena de conexion, con los parámetros de configuración
                sqlConexion = new SqlConnection("Server=" + ConfiguracionServidor.G_SERVER + ";" +
                    "Database=" + ConfiguracionServidor.G_DATABASE + ";" +
                    "User ID=" + ConfiguracionServidor.G_USER_ID + ";" +
                    "Password=" + ConfiguracionServidor.G_USER_PWD + ";");
                ...
                _StoreProcedure = new InfoStoredProcedure(this);
        ...
        public static bool ProbarConexion(string Server, string UserID, string Password)
        {
            ...
            try
            {
                ...
                strCadenaConexion = "Server=" + Server + ";" + "Database=" + ConfiguracionServidor.G_DATABASE + ";" + "User ID=" + UserID + ";" + "Password=" + Password;
    ...
    /// </summary>
    /// <remarks></remarks>
    public class InfoStoredProcedure : IDisposable
    {
        //Variable para detectar llamadas redundantes
        bool disposed = false;

        private AccesoDatos _ad;

        /// <summary>
        /// Constructor de la clase el cual inicializa los parámetros del procedimiento
        /// </summary>
        /// <remarks></remarks>
        public InfoStoredProcedure(AccesoDatos ad)
        {
